#!/usr/bin/env python3
"""
Script to create a test user for the GrantScope2 system
    ...
    try:
        ...
        if auth_response.user:
            ...
            if profile_response.data:
                ...
                print(
                    "\n🔗 You can now use these credentials to log into the GrantScope2 system."
                )
                ...
                prefs_response = (
                    supabase.table("pillar_preferences").insert(pillar_prefs).execute()
                )
