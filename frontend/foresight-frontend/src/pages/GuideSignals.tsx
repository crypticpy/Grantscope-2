  ...
  return (
    <div className="my-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-xl p-4 print:break-inside-avoid">
      <button
        ...
        className="flex items-center gap-2 w-full text-left text-sm font-semibold text-amber-600 dark:text-amber-400 transition-colors hover:text-amber-700 dark:hover:text-amber-300"
      >
        <Lightbulb
