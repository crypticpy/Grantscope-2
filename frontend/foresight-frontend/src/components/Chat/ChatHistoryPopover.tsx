...
export function ChatHistoryPopover({
  ...
  // --------------------------------------------------------------------------
  // Position the portal popover relative to trigger button
  // --------------------------------------------------------------------------
  ...
  useEffect(() => {
    ...
    const updatePosition = () => {
      ...
      const top =
        preferredTop + POPOVER_MAX_HEIGHT > window.innerHeight - VIEWPORT_GUTTER
          ? Math.max(VIEWPORT_GUTTER, rect.top - POPOVER_MAX_HEIGHT - 6)
          : preferredTop;
