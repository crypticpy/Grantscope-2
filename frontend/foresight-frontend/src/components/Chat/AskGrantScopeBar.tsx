 ...
 *
 * @module components/Chat/AskGrantScopeBar
 */
...
export interface AskGrantScopeBarProps {
...
export function AskGrantScopeBar({ className }: AskGrantScopeBarProps) {
    ...
    <form onSubmit={handleSubmit} className={cn("relative w-full", className)}>
      ...
      >
        ...
        <input
          ...
          placeholder="Ask GrantScope anything about grants, funding opportunities, and deadlines..."
          className={cn(
            "flex-1 py-4 px-3",
            "bg-transparent",
          ...
          aria-label="Ask GrantScope a question"
        />
...
export default AskGrantScopeBar;
