...
describe("PageLoadingSpinner", () => {
  ...
  describe("Message Prop", () => {
    it("renders without message by default", () => {
      ...
      expect(screen.queryByText("Loading page content...")).toHaveClass(
        "sr-only",
      );
    });
    ...
    it("displays message in paragraph element", () => {
      const { container } = render(
        <PageLoadingSpinner message="Please wait..." />,
      );
  ...
  describe("Accessibility", () => {
    ...
    it("uses custom message in screen reader text when provided", () => {
      const { container } = render(
        <PageLoadingSpinner message="Loading signals..." />,
      );

      const srText = container.querySelector(".sr-only");
      expect(srText).toHaveTextContent("Loading signals...");
    });
  });
